module.exports = {
    ...
    bracketSpacing: false, // Change { foo: bar } to {foo: bar}
    jsxBracketSameLine: false, // See https://prettier.io/docs/en/options.html#jsx-brackets
    arrowParens: 'always', // For consistency. See https://prettier.io/docs/en/options.html#arrow-function-parentheses
    proseWrap: 'always',
};
